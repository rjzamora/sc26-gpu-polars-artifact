...
For paper runs, use the public `paper-dynamic-planning-overrides` cudf branch. The experiment-code snapshot is archived at Zenodo DOI `10.5281/zenodo.21906536`. See `env/cudf-polars-benchmark-env.md` for the environment runbook and `configs/production-b200.yaml` for the initial B200 software-stack pin.
